...
(function(u, e) {
  ...
  var j = { font: "Arial", size: 100 }, S = function(a, o) {
    var t = f({}, j, o), i = t.font.toLowerCase(), E = t.size, _ = 0 + (t.bold ? 1 : 0) + (t.italic ? 2 : 0), d = t.map || w.default, l = Object.keys(d);
    if (l.indexOf(i) === -1)
      throw new Error("This font is not supported. Supported fonts are: " + l.join(", "));
    var b = 0;
