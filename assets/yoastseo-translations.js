const e = [
  ...
  "%1$s of the words contain %2$sover %3$s syllables%4$s, which is less than or equal to the recommended maximum of %5$s.": [
    "%1$s van de woorden bevatten meer dan %3$s lettergrepen%4$s. Dat is minder dan of gelijk aan het aanbevolen maximum van %5$s."
  ],
  "%1$s of the words contain %2$sover %3$s syllables%4$s, which is more than the recommended maximum of %5$s.": [
    "%1$s van de woorden bevatten meer dan %3$s lettergrepen%4$s. Dat is meer dan het aanbevolen maximum van %5$s."
  ],
  "%1$sConsecutive sentences%2$s: The text contains %3$d consecutive sentences starting with the same word. %5$sTry to mix things up%2$s!": [
    "%1$sOpeenvolgende zinnen%2$s: De tekst bevat %3$d opeenvolgende zinnen die met hetzelfde woord beginnen. %5$sProbeer te variëren%2$s!",
    "%1$sOpeenvolgende zinnen%2$s: De tekst bevat %4$d gevallen waarin %3$d of meer opeenvolgende zinnen met hetzelfde woord beginnen. %5$sProbeer te variëren%2$s!"
  ],
  "%1$sConsecutive sentences%2$s: There is enough variety in your sentences. That's great!": [
    "%1$sOpeenvolgende zinnen%2$s: Er zit genoeg afwisseling in je zinnen. Dat is top!"
  ],
  "%1$sFlesch Reading Ease%2$s: The copy scores %3$s in the test, which is considered %4$s to read. %5$s": [
    "%1$sFlesch leesbaarheidsindex%2$s: De tekst bereikt %3$s in de test. Dat wordt beschouwd als %4$s om te lezen. %5$s"
  ],
  "%1$sFlesch Reading Ease%2$s: The copy scores %3$s in the test, which is considered %4$s to read. %5$s%6$s%7$s": [
    "%1$sFlesch leesbaarheidsindex%2$s: De tekst bereikt %3$s in de test. Dat wordt beschouwd als %4$s om te lezen. %5$s%6$s%7$s"
  ],
  '%1$sFunction words in keyphrase%3$s: Your keyphrase "%4$s" contains function words only. %2$sLearn more about what makes a good keyphrase.%3$s': [
    '%1$sFunctiewoorden in sleutelwoord%3$s: Je trefzin "%4$s" bevat alleen functiewoorden. %2$sLees meer over wat een goed sleutelwoord is.%3$s'
  ],
  "%1$sImage alt attributes%2$s: Good job!": [
    "%1$sAlt-tekst van afbeeldingen%2$s: Goed werk!"
  ],
  "%1$sImage alt attributes%3$s: Images on this page do not have alt attributes that reflect the topic of your text. %2$sAdd your keyphrase or synonyms to the alt tags of relevant images%3$s!": [
    "%1$sAlt-tekst van afbeeldingen%3$s: Afbeeldingen op deze pagina hebben geen alt-tekst die het onderwerp van je tekst weergeven. %2$Voeg je sleutelwoord of synoniemen toe aan de alt-tekst van relevante afbeeldingen%3$s!"
  ],
  "%1$sImage alt attributes%3$s: Images on this page have alt attributes, but you have not set your keyphrase. %2$sFix that%3$s!": [
    "%1$sAlt-tekst van afbeeldingen%3$s: Afbeeldingen op deze pagina hebben alt-tekst, maar je hebt je trefwoord niet ingesteld. %2$sAanpassing aanbevolen%3$s!"
  ],
  "%1$sImage alt attributes%3$s: No images appear on this page. %2$sAdd some%3$s!": [
    "%1$sAlt-tekst van afbeeldingen%3$s: Er staan geen afbeeldingen op deze pagina. %2$sVoeg er een paar toe%3$s!"
  ],
  "%1$sInternal links%2$s: There are both nofollowed and normal internal links on this page. Good job!": [
    "%1$sInterne links%2$s: Er zijn zowel nofollow als normale interne links op deze pagina. Goed werk!"
  ],
  "%1$sInternal links%2$s: You have enough internal links. Good job!": [
    "%1$sInterne links%2$s: Je hebt genoeg interne links. Goed werk!"
  ],
  "%1$sInternal links%3$s: No internal links appear in this page, %2$smake sure to add some%3$s!": [
    "%1$sInterne links%3$s: Er staan geen interne links op deze pagina, %2$zorg ervoor dat je er een paar toevoegt%3$s!"
  ],
  ...
  "%1$sKeyphrase density%2$s: The focus keyphrase was found %3$d time. This is great!": [
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %3$d keer gevonden. Dat is top!",
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %3$d keer gevonden. Dat is top!"
  ],
  "%1$sKeyphrase density%2$s: The focus keyphrase was found %5$d time. That's less than the recommended minimum of %3$d times for a text of this length. %4$sFocus on your keyphrase%2$s!": [
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is minder dan het aanbevolen minimum van %3$d keer voor een tekst van deze lengte. %4$sConcentreer je op je trefwoord%2$s!",
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is minder dan het aanbevolen minimum van %3$d keer voor een tekst van deze lengte. %4$sConcentreer op uw trefwoord%2$s!"
  ],
  "%1$sKeyphrase density%2$s: The focus keyphrase was found %5$d time. That's more than the recommended maximum of %3$d times for a text of this length. %4$sDon't overoptimize%2$s!": [
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is meer dan het aanbevolen maximum van %3$d keer voor een tekst van deze lengte. %4$sNiet te veel optimaliseren%2$s!",
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is meer dan het aanbevolen maximum van %3$d keer voor een tekst van deze lengte. %4$sNiet te veel optimaliseren%2$s!"
  ],
  "%1$sKeyphrase density%2$s: The focus keyphrase was found %5$d time. That's way more than the recommended maximum of %3$d times for a text of this length. %4$sDon't overoptimize%2$s!": [
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is veel meer dan het aanbevolen maximum van %3$d keer voor een tekst van deze lengte. %4$sNiet te veel optimaliseren%2$s!",
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is %5$d keer gevonden. Dit is veel meer dan het aanbevolen maximum van %3$d keer voor een tekst van deze lengte. %4$sNiet te veel optimaliseren%2$s!"
  ],
  "%1$sKeyphrase density%2$s: The focus keyphrase was found 0 times. That's less than the recommended minimum of %3$d times for a text of this length. %4$sFocus on your keyphrase%2$s!": [
    "%1$sSleutelwoord dichtheid%2$s: Het sleutelwoord is 0 keer gevonden. Dit is minder dan het aanbevolen minimum van %3$d keer voor een tekst van deze lengte. %4$sConcentreer je op je sleutelwoord%2$s!"
  ],
  "%1$sKeyphrase distribution%2$s: Good job!": [
    "%1$sVerdeling van sleutelwoord%2$s: Goed werk!"
  ],
  "%1$sKeyphrase distribution%3$s: %2$sInclude your keyphrase or its synonyms in the text so that we can check keyphrase distribution%3$s.": [
    "%1$sVerdeling van sleutelwoord%3$s: %2$sVoer je sleutelwoord of de synoniemen ervan in de tekst in, zodat we de verdeling van het sleutelwoord%3$s kunnen controleren."
  ],
  "%1$sKeyphrase distribution%3$s: Uneven. Some parts of your text do not contain the keyphrase or its synonyms. %2$sDistribute them more evenly%3$s.": [
    "%1$sVerdeling van sleutelwoord%3$s: Ongelijke verdeling. Sommige delen van je tekst bevatten het sleutelwoord of de synoniemen ervan niet. %2$sVerdeel ze gelijkmatiger%3$s."
  ],
  "%1$sKeyphrase distribution%3$s: Very uneven. Large parts of your text do not contain the keyphrase or its synonyms. %2$sDistribute them more evenly%3$s.": [
    "%1$sVerdeling van sleutelwoord%3$s: Zeer ongelijkmatig verdeeld. Grote delen van je tekst bevatten het sleutelwoord of synoniemen ervan niet. %2$sVerdeel ze gelijkmatiger%3$s."
  ],
  "%1$sKeyphrase in introduction%2$s: Well done!": [
    "%1$sSleutelwoord in inleiding%2$s: Goed gedaan!"
  ],
  "%1$sKeyphrase in introduction%3$s: Your keyphrase or its synonyms do not appear in the first paragraph. %2$sMake sure the topic is clear immediately%3$s.": [
    "%1$sSleutelwoord in inleiding%3$s: Je sleutelwoord of synoniemen ervan komen niet voor in de eerste alinea. %2$sZorg ervoor dat het onderwerp meteen duidelijk is%3$s."
  ],
  "%1$sKeyphrase in introduction%3$s:Your keyphrase or its synonyms appear in the first paragraph of the copy, but not within one sentence. %2$sFix that%3$s!": [
    "%1$sSleutelwoord in inleiding%3$s: Je sleutelwoord of synoniemen ervan verschijnen in de eerste alinea van de tekst, maar niet binnen een zin. %2$sAanpassing aanbevolen%3$s!"
  ],
  "%1$sKeyphrase in meta description%2$s: Keyphrase or synonym appear in the meta description. Well done!": [
    "%1$sSleutelwoord in metabeschrijving%2$s: Sleutelwoord of synoniem verschijnt in de metabeschrijving. Goed gedaan!"
  ],
  "%1$sKeyphrase in meta description%2$s: The meta description contains the keyphrase %3$s times, which is over the advised maximum of 2 times. %4$sLimit that%5$s!": [
    "%1$sSleutelwoord in metabeschrijving%2$s: De metabeschrijving bevat de sleutelwoord %3$s keer, wat boven het aanbevolen maximum van 2 keer is. %4$sLimiet aanbevolen%5$s!"
  ],
  "%1$sKeyphrase in meta description%2$s: The meta description has been specified, but it does not contain the keyphrase. %3$sFix that%4$s!": [
    "%1$sSleutelwoord in metabeschrijving%2$s: De metabeschrijving is opgegeven, maar bevat het sleutelwoord niet. %3$sAanpassing aanbevolen%4$s!"
  ],
  "%1$sKeyphrase in slug%2$s: Great work!": [
    "%1$sSleutelwoord in Slug%2$s: Goed gedaan!"
  ],
  "%1$sKeyphrase in slug%2$s: More than half of your keyphrase appears in the slug. That's great!": [
    "%1$Sleutelwoord in slug%2$s: Meer dan de helft van je sleutelwoord komt voor in de slug. Dat is top!"
  ],
  "%1$sKeyphrase in slug%3$s: (Part of) your keyphrase does not appear in the slug. %2$sChange that%3$s!": [
    "%1$sSleutelwoord in slug%3$s: (Een deel van) je sleutelwoord komt niet voor in de slug. %2$sAanpassing aanbevolen%3$s!"
  ],
  "%1$sKeyphrase in subheading%2$s: %3$s of your H2 and H3 subheadings reflects the topic of your copy. Good job!": [
    "%1$sSleutelwoord in titels%2$s: %3$s van je H2 en H3 titels weerspiegelen het onderwerp van je tekst. Goed werk!",
    "%1$sSleutelwoord in titels%2$s: %3$s van je H2 en H3 titels weerspiegelen het onderwerp van je tekst. Goed werk!"
  ],
  "%1$sKeyphrase in subheading%2$s: Your H2 or H3 subheading reflects the topic of your copy. Good job!": [
    "%1$sSleutelwoord in titels%2$s: Je H2 of H3 titels weerspiegelen het onderwerp van je tekst. Goed werk!"
  ],
  "%1$sKeyphrase in subheading%3$s: %2$sUse more keyphrases or synonyms in your H2 and H3 subheadings%3$s!": [
    "%1$sSleutelwoord in titels%3$s: %2$sGebruik het sleutelwoord (of synoniemen ervan) meer in je H2 en H3 titels%3$s!"
  ],
  "%1$sKeyphrase in subheading%3$s: More than 75%% of your H2 and H3 subheadings reflect the topic of your copy. That's too much. %2$sDon't over-optimize%3$s!": [
    "%1$sSleutelwoord in titels%3$s: Meer dan 75%% van je H2 en H3 titels bevatten het sleutelwoord. Dit is te veel. %2$sOptimaliseer niet te veel%3$s!"
  ],
  "%1$sKeyphrase in title%2$s: The exact match of the focus keyphrase appears at the beginning of the SEO title. Good job!": [
    "%1$sSleutelwoord in SEO-titel%2$s: De exacte match van het sleutelwoord verschijnt aan het begin van de SEO-titel. Goed werk!"
  ],
  "%1$sKeyphrase in title%3$s: Does not contain the exact match. %2$sTry to write the exact match of your keyphrase in the SEO title and put it at the beginning of the title%3$s.": [
    "%1$sSleutelwoord in SEO-titel%3$s: Je SEO-titel bevat het sleutelwoord niet. %2$sProbeer de exacte match van je sleutelwoord in de SEO-titel te schrijven en plaats deze aan het begin van de titel%3$s."
  ],
  '%1$sKeyphrase in title%3$s: Not all the words from your keyphrase "%4$s" appear in the SEO title. %2$sFor the best SEO results write the exact match of your keyphrase in the SEO title, and put the keyphrase at the beginning of the title%3$s.': [
    '%1$sSleutelwoord in titel%3$s: Niet alle woorden van je sleutelwoord "%4$s" verschijnen in de SEO titel. %2$sVoor de beste SEO resultaten, schrijf je de exacte match van je sleutelwoord in de SEO titel en plaats je het sleutelwoord aan het begin van de titel%3$s.'
  ],
  "%1$sKeyphrase in title%3$s: The exact match of the focus keyphrase appears in the SEO title, but not at the beginning. %2$sMove it to the beginning for the best results%3$s.": [
    "%1$sSleutelwoord in titel%3$s: De exacte match van het sleutelwoord staat in de SEO-titel, maar niet aan het begin. %2$sVerplaats het naar het begin voor de beste resultaten%3$s."
  ],
  "%1$sKeyphrase length%2$s: Good job!": [
    "%1$sSleutelwoord lengte%2$s: Goed gedaan!"
  ],
  "%1$sKeyphrase length%3$s: %2$sSet a keyphrase in order to calculate your SEO score%3$s.": [
    "%1$sSleutelwoord lengte%3$s: %2$sStel een sleutelwoord in om je SEO score te berekenen%3$s."
  ],
  "%1$sKeyphrase length%3$s: No focus keyphrase was set for this page. %2$sSet a keyphrase in order to calculate your SEO score%3$s.": [
    "%1$sSleutelwoord lengte%3$s: Er is geen sleutelwoord ingesteld voor deze pagina. %2$sStel een sleutelwoord in om je SEO score te berekenen%3$s."
  ],
  "%1$sLink keyphrase%3$s: You're linking to another page with the words you want this page to rank for. %2$sDon't do that%3$s!": [
    "%1$sSleutelwoord links%3$s: Je linkt naar een andere pagina met het sleutelwoord waarvoor je wilt dat deze pagina rankt. %2$sDoe dat niet%3$s!"
  ],
  "%1$sMeta description length%2$s: Well done!": [
    "%1$sLengte van metabeschrijving%2$s: Goed gedaan!"
  ],
  "%1$sMeta description length%3$s: No meta description has been specified. Search engines will display copy from the page instead. %2$sMake sure to write one%3$s!": [
    "%1$sLengte van metabeschrijving%3$s: Er is geen metabeschrijving opgegeven. Zoekmachines zullen in plaats daarvan tekst van de pagina weergeven. %2$sZorg ervoor dat je er een schrijft%3$s!"
  ],
  "%1$sMeta description length%3$s: The meta description is over %4$d characters. To ensure the entire description will be visible, %2$syou should reduce the length%3$s!": [
    "%1$sLengte van metabeschrijving%3$s: De metabeschrijving is langer dan %4$d tekens. Om ervoor te zorgen dat de hele beschrijving zichtbaar is, moet je de lengte met %2$ verminderen%3$s!"
  ],
  "%1$sMeta description length%3$s: The meta description is too short (under %4$d characters). Up to %5$d characters are available. %2$sUse the space%3$s!": [
    "%1$sLengte van metabeschrijving%3$s: De metabeschrijving is te kort (minder dan %4$d tekens). Er zijn maximaal %5$d tekens beschikbaar. %2$sGebruik de ruimte%3$s!"
  ],
  ...
  "%1$sOutbound links%2$s: Good job!": [
    "%1$sExterne links%2$s: Goed werk!"
  ],
  "%1$sOutbound links%2$s: There are both nofollowed and normal outbound links on this page. Good job!": [
    "%1$sExterne links%2$s: Er zijn zowel nofollow als normale externe links op deze pagina. Goed werk!"
  ],
  "%1$sOutbound links%3$s: All outbound links on this page are nofollowed. %2$sAdd some normal links%3$s.": [
    "%1$sExterne links%3$s: Alle externe links op deze pagina zijn nofollow. %2$sVoeg wat normale links toe%3$s."
  ],
  "%1$sOutbound links%3$s: No outbound links appear in this page. %2$sAdd some%3$s!": [
    "%1$sExterne links%3$s: Er zijn geen externe links op deze pagina. %2$sVoeg er een paar toe%3$s!"
  ],
  "%1$sParagraph length%2$s: %3$d of the paragraphs contains more than the recommended maximum of %4$d words. %5$sShorten your paragraphs%2$s!": [
    "%1$sParagraaflengte%2$s: %3$d van de paragrafen bevat meer dan het aanbevolen maximum van %4$d woorden. %5$sKort uw alinea's in%2$s!",
    "%1$sParagraaflengte%2$s: %3$d van de paragrafen bevat meer dan het aanbevolen maximum van %4$d woorden. %5$sKort je alinea's in%2$s!"
  ],
  "%1$sParagraph length%2$s: None of the paragraphs are too long. Great job!": [
    "%1$sParagraaflengte%2$s: Geen van de paragrafen is te lang. Goed gedaan!"
  ],
  "%1$sPassive voice%2$s: %3$s of the sentences contain passive voice, which is more than the recommended maximum of %4$s. %5$sTry to use their active counterparts%2$s.": [
    "%1$sPassieve constructies%2$s: %3$s van de zinnen bevat passieve constructies. Dat is meer dan het aanbevolen maximum van %4$s. %5$sProbeer actieve formuleringen te gebruiken%2$s."
  ],
  "%1$sPassive voice%2$s: You're using enough active voice. That's great!": [
    "%1$sPassieve constructies%2$s: Je gebruikt genoeg actieve formuleringen. Dat is top!"
  ],
  "%1$sPreviously used keyphrase%2$s: You've not used this keyphrase before, very good.": [
    "%1$sAl gebruikte trefzin%2$s: Je hebt deze trefzin nog niet eerder gebruikt, heel goed."
  ],
  "%1$sSentence length%2$s: %3$s of the sentences contain more than %4$s words, which is more than the recommended maximum of %5$s. %6$sTry to shorten the sentences%2$s.": [
    "%1$sZinslengte%2$s: %3$s van de zinnen bevatten meer dan %4$s woorden, wat meer is dan het aanbevolen maximum van %5$s. %6$sProbeer de zinnen in te korten%2$s."
  ],
  "%1$sSentence length%2$s: Great!": [
    "%1$sZinslengte%2$s: Geweldig!"
  ],
  "%1$sSEO title width%2$s: Good job!": [
    "%1$sSEO-titelbreedte%2$s: Goed werk!"
  ],
  "%1$sSEO title width%3$s: %2$sPlease create an SEO title%3$s.": [
    "%1$sSEO-titelbreedte%3$s: %2$sMaak een SEO-titel%3$s."
  ],
  "%1$sSEO title width%3$s: The SEO title is too short. %2$sUse the space to add keyphrase variations or create compelling call-to-action copy%3$s.": [
    "%1$sSEO-titelbreedte%3$s: De SEO-titel is te kort. %2$sGebruik de ruimte om variaties van de trefwoordzin toe te voegen of maak overtuigende oproepen tot actie%3$s."
  ],
  "%1$sSEO title width%3$s: The SEO title is wider than the viewable limit. %2$sTry to make it shorter%3$s.": [
    "%1$sSSEO-titelbreedte%3$s: De SEO-titel is breder dan de zichtbare limiet. %2$sProbeer hem korter te maken%3$s."
  ],
  "%1$sSingle title%3$s: H1s should only be used as your main title. Find all H1s in your text that aren't your main title and %2$schange them to a lower heading level%3$s!": [
    "%1$sEnkele titel%3$s: H1's mogen alleen gebruikt worden als je hoofdtitel. Zoek alle H1's in je tekst die niet je hoofdtitel zijn en %2$verander ze naar een lager kopniveau%3$s!"
  ],
  ...
  "%1$sSlug too long%3$s: the slug for this page is a bit long. %2$sShorten it%3$s!": [
    "%1$sSlug te lang%3$s: De slug voor deze pagina is iets te lang. %2$sKort hem in%3$s!"
  ],
  "%1$sStopwords%3$s: The keyphrase contains stop words. This may or may not be wise depending on the circumstances. %2$sLearn more about stop words%3$s.": [
    "%1$sStopwords%3$s: De trefzin bevat stopwoorden. Dit kan wel of niet verstandig zijn, afhankelijk van de omstandigheden. %2$sLees meer over stopwoorden%3$s."
  ],
  "%1$sSubheading distribution%2$s: %3$d section of your text is longer than %4$d words and is not separated by any subheadings. %5$sAdd subheadings to improve readability%2$s.": [
    "%1$sDistributie van subtitels%2$s: %3$d gedeelte van je tekst is langer dan %4$d woorden en wordt niet gescheiden door een titel. %5$Voeg een titel toe om de leesbaarheid te verbeteren%2$s.",
    "%1$sDistributie van subtitels%2$s: %3$d secties van je tekst zijn langer dan %4$d woorden en worden niet gescheiden door een titel. %5$sTitel toevoegen om de leesbaarheid te verbeteren%2$s."
  ],
  "%1$sSubheading distribution%2$s: Great job!": [
    "%1$sDistributie van subtitels%2$s: Goed werk!"
  ],
  "%1$sSubheading distribution%2$s: You are not using any subheadings, although your text is rather long. %3$sTry and add some subheadings%2$s.": [
    "%1$sDistributie van subtitels%2$s: Je gebruikt geen subtitels, hoewel je tekst vrij lang is. %3$sProbeer wat tests toe te voegen%2$s."
  ],
  "%1$sSubheading distribution%2$s: You are not using any subheadings, but your text is short enough and probably doesn't need them.": [
    "%1$sDistributie van subtitels%2$s: Je gebruikt geen subtitels, maar je tekst is kort genoeg en heeft het waarschijnlijk niet nodig."
  ],
  "%1$sTransition words%2$s: None of the sentences contain transition words. %3$sUse some%2$s.": [
    "%1$sOvergangswoorden%2$s: Geen van de zinnen bevat overgangswoorden. %3$sGebruik welke%2$s."
  ],
  "%1$sTransition words%2$s: Only %3$s of the sentences contain transition words, which is not enough. %4$sUse more of them%2$s.": [
    "%1$sOvergangswoorden%2$s: Slechts %3$s van de zinnen bevat overgangswoorden, dat is niet genoeg. %4$sGebruik er meer%2$s."
  ],
  ...
  "%3$sImage alt attributes%5$s: Out of %2$d images on this page, %1$d have alt attributes with words from your keyphrase or synonyms. That's a bit much. %4$sOnly include the keyphrase or its synonyms when it really fits the image%5$s.": [
    "%3$sAlt Text van afbeeldingen%5$s: Van %2$d afbeeldingen op deze pagina hebben %1$d Alt Text met woorden uit je trefwoord of synoniemen. Dit is een beetje veel. %4$sVoeg de trefwoordzin of zijn synoniemen alleen toe als ze echt bij de afbeelding passen%5$s."
  ],
  "%3$sImage alt attributes%5$s: Out of %2$d images on this page, only %1$d has an alt attribute that reflects the topic of your text. %4$sAdd your keyphrase or synonyms to the alt tags of more relevant images%5$s!": [
    "%3$sAlt Text van afbeeldingen%5$s: Van %2$d afbeeldingen op deze pagina heeft alleen %1$d een alt attribuut dat het onderwerp van je tekst weergeeft. %4$s Voeg je trefwoord of synoniemen toe aan de alt-tags van relevantere afbeeldingen%5$s!",
    "%3$sAlt Text van afbeeldingen%5$s: Van %2$d afbeeldingen op deze pagina, hebben slechts %1$d Alt Text die het onderwerp van je tekst weergeven. %4$sVoeg je trefwoord of synoniemen toe aan de alt-tags van relevantere afbeeldingen%5$s!"
  ],
  "%3$sKeyphrase length%5$s: The keyphrase is %1$d words long. That's more than the recommended maximum of %2$d words. %4$sMake it shorter%5$s!": [
    "%3$sLengte van het sleutelwoord%5$s: Het sleutelwoord is %1$d woorden lang. Dit is meer dan het aanbevolen maximum van %2$d woorden. %4$sMaak het korter%5$s!"
  ],
  "%3$sKeyphrase length%5$s: The keyphrase is %1$d words long. That's way more than the recommended maximum of %2$d words. %4$sMake it shorter%5$s!": [
    "%3$sLengte van het sleutelwoord%5$s: Het sleutelwoord is %1$d woorden lang. Dit is veel meer dan het aanbevolen maximum van %2$d woorden. %4$sMaak het korter%5$s!"
  ],
  "%3$sPreviously used keyphrase%5$s: You've used this keyphrase %1$sonce before%2$s. %4$sDo not use your keyphrase more than once%5$s.": [
    "%3$sEerder gebruikt sleutelwoord%5$s: Je hebt dit sleutelwoord %1$een keer eerder gebruikt%2$s. %4$sGebruik je sleutelwoord niet meer dan één keer%5$s."
  ],
  "%4$sPreviously used keyphrase%6$s: You've used this keyphrase %1$s%2$d times before%3$s. %5$sDo not use your keyphrase more than once%6$s.": [
    "%4$sEerder gebruikt sleutelwoord%6$s: Je hebt dit sleutelwoord %1$s%2$d keer eerder gebruikt%3$s. %5$sGebruik je sleutelwoord niet meer dan één keer%6$s."
  ],
  "An error occurred in the '%1$s' assessment": [
    "Er is een fout opgetreden tijdens de '%1$s'-audit."
  ],
  ...
  "Marks are disabled in current view": [
    "Markeringen zijn in de huidige weergave uitgeschakeld"
  ],
  "Meta description": [
    "metabeschrijving"
  ],
  "Meta description preview:": [
    "Voorbeeld van metabeschrijving:"
  ],
  "Mobile preview": [
    "Mobiel voorbeeld"
  ],
  ...
  "Please provide a meta description by editing the snippet below.": [
    "Geef een metabeschrijving door de onderstaande snippet te bewerken."
  ],
  ...
  "Remove marks in the text": [
    "Markeringen in de tekst verwijderen"
  ],
  ...
  "The meta description contains %1$d sentence %2$sover %3$s words%4$s. Try to shorten this sentence.": [
    "De metabeschrijving bevat %1$d zin %2$smet meer dan %3$s woorden%4$s. Probeer deze zin in te korten.",
    "De metabeschrijving bevat %1$d zinnen %2$smet meer dan %3$s woorden%4$s. Probeer deze zinnen in te korten."
  ],
  "The meta description contains no sentences %1$sover %2$s words%3$s.": [
    "De metabeschrijving bevat geen zinnen %1$smet meer dan %2$s woorden%3$s."
  ],
  "This is below the recommended minimum of %5$d word. %3$sAdd more content%4$s.": [
    "Dit ligt onder het aanbevolen minimum van %5$d woord. %3$sVoeg meer inhoud toe%4$s.",
    "Dit ligt onder het aanbevolen minimum van %5$d woorden. %3$sVoeg meer inhoud toe%4$s."
  ],
  "This is far below the recommended minimum of %5$d word. %3$sAdd more content%4$s.": [
    "Dit ligt ver onder het aanbevolen minimum van %5$d woord. %3$sVoeg meer inhoud toe%4$s.",
    "Dit ligt ver onder het aanbevolen minimum van %5$d woorden. %3$sVoeg meer inhoud toe%4$s."
  ],
  "This is slightly below the recommended minimum of %5$d word. %3$sAdd a bit more copy%4$s.": [
    "Dit ligt iets onder het aanbevolen minimum van %5$d woord. %3$sVoeg een beetje meer inhoud toe%4$s.",
    "Dit ligt iets onder het aanbevolen minimum van %5$d woorden. %3$sVoeg een beetje meer inhoud toe%4$s."
  ],
  ...
  "You can click on each element in the preview to jump to the Snippet Editor.": [
    "Je kan op elk element in de preview klikken om naar de Snippet-editor te gaan."
  ]
}, $ = [
  "schwierig"
], d = [
